...
const Progress = ({
    ...
    return ( <
        ...
        /h2> <
        section className = "justify-content-center  bg-light p-2 my-2"
        id = "pounds-lost" >
        ...
        <
        section className = "justify-content-center align-items-center d-flex bg-light p-2 my-2"
        id = "pounds-to-lose" >
        ...
        <
        section className = "container bg-light p-2 my-2"
        id = "pounds-box" >
        <
